    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-4 m-auto" style="height: 250px;">
          ...
          <img id="previewimg" style="height: 250px; width:100%; border:none;outline:none;"src="{{asset('images/controller')}}/{{$get[0]->photo}}" alt="Insert Image" />
              ...
              <div class="row">
                <div class="col-sm-9 m-auto">
                  <div class="form-grop">
                    ...
                    <!--=====Add Two Hidden File =====--> 
                  <input type="hidden" name="who" value="controller">
